...
public class CollectionView extends ListView {
  ...
  public CollectionView(Context context) {
    ...
    public void updateInventory(ListFragment fragment, final Inventory inv) {
        updateInventory(fragment, inv, true);
    }

    public void updateInventory(ListFragment fragment, final Inventory inv, boolean animate) {
